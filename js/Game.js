class Game {
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 3 - 330, height - player.positionY - 320, 20, 20);
    fill("white");
    rect(width / 3 - 300, height - player.positionY - 320, 185, 20);
    fill("#ffc400");
    rect(width / 3 - 300, height - player.positionY - 320, player.fuel, 20);
    noStroke();
    pop();
  }
  ...
  showLife() {
    push();
    image(lifeImage, width / 3 - 330, height - player.positionY - 200, 20, 20);
    fill("white");
    rect(width / 3 - 300, height - player.positionY - 200, 185, 20);
    fill("#f50057");
    rect(width / 3 - 300, height - player.positionY - 200, player.life, 20);
    noStroke();
    pop();
  }
